...
const BYTE Int64_2[8] = { 0x50,0xA9,0x29,0x28,0,0,0,0};     //673818960
const BYTE Int64_3[8] = { 0x04,0xd3,0x02,0x93,0x0c,0,0,0};
const BYTE Int64_4[8] = { 0x04,0xd3,0x02,0x93,0xa5,0,0,0};
const BYTE Int128_5[16] = { ,0,0,0,0,0,0,0,0 };
const BYTE Int128_6[16] = { 0x04,0xd3,0x02,0x12,0x05,0xac,0x8d,0x10,0x09,0,0,0,0,0,0,0 };   //4188603703346168255236
