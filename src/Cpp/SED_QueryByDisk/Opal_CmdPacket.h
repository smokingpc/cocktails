...
public:
    ...
    void BeginList();
    void EndList();
    void PushKeypair(char* name, int strlen, UINT8 value);
    void PushKeypair(char *name, int strlen, UINT16 value);
    void PushKeypair(char* name, int strlen, UINT32 value);
    void PushKeypair(char* name, int strlen, UINT64 value);
    void PushString(char *str, int strlen);
    void PushBytes(BYTE* blob, int bloblen);
